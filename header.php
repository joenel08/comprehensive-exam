<head>
  ...
  ?>
  <title><?php echo $title ?> | Comprehensive Examination</title>
  <?php ob_end_flush() ?>
  <link rel="shortcut icon" href="assets/img/spup_logo.png" type="image/x-icon">
  ...
  <!-- full calendar -->
  <link href="assets/plugins/fullcalendar/main.min.css" rel="stylesheet">
