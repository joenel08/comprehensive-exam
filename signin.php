...
<head>
    ...
    <title>Sign-in | Comprehensive Exam </title>
    ...
    <div class="login-box">
        ...
        <div class="card card-outline card-success">
            <div class="card-header text-center">
                ...
                <img src="assets/img/spup_logo.png" width="50%" alt="">

            </div>
            <div class="card-body">
                <span id="status-alert"></span>
                <div class="text-center">
                    <a href="#" class="h3 text-center"><b>Welcome!</b></a>
                ...
                <form id="login-form" action="" method="POST">
                    ...
                    <div class="social-auth-links text-center mt-2 mb-3">
                        ...
                        <p class="text-muted mt-2">Don't have an account? <a href="signup.php" class="text-success">Sign-up Now</a></p>
