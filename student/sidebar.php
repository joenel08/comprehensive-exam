...
<aside class="main-sidebar">
  ...
  <a href="./" class="brand-link shadow">
    ...
    <span class="brand-text h4 font-weight-bold text-white">Student Panel</span>
  </a>
  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column nav-flat" data-widget="treeview" role="menu"
        ...
        <?php
        $verdict_qry = $conn->query("SELECT * FROM dean_approval WHERE student_id = '{$_SESSION['login_id']}'");
        if ($verdict_qry && $verdict_qry->num_rows > 0) { ?>
              <li class="nav-item dropdown">
          <a href="./index.php?page=comprehensive_examination_form" class="nav-link nav-comprehensive_examination_form">
