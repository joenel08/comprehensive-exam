		...
		<div class="card-body">
			<table class="table table-hover table-bordered" id="list">
				...
				<tbody>
					<?php
					$i = 1;
					$qry = $conn->query("SELECT *, CONCAT( extname,' ',firstname, ' ', lastname) AS fullname FROM dean_users ORDER BY CONCAT(firstname,' ',lastname) ASC");
					...
					<tr>
						...
						<td class="text-center">
		                    ...
		                    <div class="dropdown-menu">
		                      ...
		                      <a class="dropdown-item" href="./index.php?page=edit_dean_user&id=<?php echo $row['id'] ?>">Edit</a>
		                      <div class="dropdown-divider"></div>
