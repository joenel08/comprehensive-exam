<div class="row">
    ...
    <div class="col-sm">
        ...
        while ($strow = $student->fetch_assoc()):
            $student_level = $strow['level'];
        endwhile;
            ...
            <div class="card-header">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="d-flex">
                        ...
                        <a href="./index.php?page=download_form&student_id=<?php echo $_GET['student_id'] ?>"
                            class="btn btn-flat btn-info">Print</a>
                    </div>
                ...
                <table class="table table-bordered table-hover mb-0" id="list">
                    ...
                    <tbody>
                        ...
                        while ($row = $qry->fetch_assoc()):
                            ...
                            $subject_list = $conn->query("SELECT * FROM subject_list WHERE sub_id = $subject_id and subject_level = '$student_level'");
